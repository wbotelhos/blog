...
describe Article, "#new" do
  context "when logged" do
    ...
    context "form" do
      ...
      it { page.should have_field "category-#{category_1.id.to_s}" }
      it { page.should have_field "category-#{category_2.id.to_s}" }
      it { page.should have_field "category-#{category_3.id.to_s}" }
